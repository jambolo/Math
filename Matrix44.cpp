...
Matrix44::Matrix44( Matrix33 const & m33, Vector3 const & t/* = Vector3::Origin()*/ )
	: m_Xx( m33.m_Xx ), m_Xy( m33.m_Xy ), m_Xz( m33.m_Xz ), m_Xw( 0.0f ),
	  m_Yx( m33.m_Yx ), m_Yy( m33.m_Yy ), m_Yz( m33.m_Yz ), m_Yw( 0.0f ),
	  m_Zx( m33.m_Zx ), m_Zy( m33.m_Zy ), m_Zz( m33.m_Zz ), m_Zw( 0.0f ),
...
Matrix44::Matrix44( Matrix43 const & m43 )
	: m_Xx( m43.m_Xx ), m_Xy( m43.m_Xy ), m_Xz( m43.m_Xz ), m_Xw( 0.0f ),
	  m_Yx( m43.m_Yx ), m_Yy( m43.m_Yy ), m_Yz( m43.m_Yz ), m_Yw( 0.0f ),
	  m_Zx( m43.m_Zx ), m_Zy( m43.m_Zy ), m_Zz( m43.m_Zz ), m_Zw( 0.0f ),
	  m_Tx( m43.m_Tx ), m_Ty( m43.m_Ty ), m_Tz( m43.m_Tz ), m_Tw( 1.0f )
{
}
...
Matrix44::Matrix44( Matrix44d const & m44d )
	: m_Xx( float( m44d.m_Xx ) ), m_Xy( float( m44d.m_Xy ) ), m_Xz( float( m44d.m_Xz ) ), m_Xw( float( m44d.m_Xw ) ),
	  m_Yx( float( m44d.m_Yx ) ), m_Yy( float( m44d.m_Yy ) ), m_Yz( float( m44d.m_Yz ) ), m_Yw( float( m44d.m_Yw ) ),
	  m_Zx( float( m44d.m_Zx ) ), m_Zy( float( m44d.m_Zy ) ), m_Zz( float( m44d.m_Zz ) ), m_Zw( float( m44d.m_Zw ) ),
	  m_Tx( float( m44d.m_Tx ) ), m_Ty( float( m44d.m_Ty ) ), m_Tz( float( m44d.m_Tz ) ), m_Tw( float( m44d.m_Tw ) )
{
}
