...
Matrix44d::Matrix44d( Matrix33d const & m33, Vector3d const & t/* = Vector3d::Origin()*/ )
	: m_Xx( m33.m_Xx ), m_Xy( m33.m_Xy ), m_Xz( m33.m_Xz ), m_Xw( 0.0 ),
	  m_Yx( m33.m_Yx ), m_Yy( m33.m_Yy ), m_Yz( m33.m_Yz ), m_Yw( 0.0 ),
	  m_Zx( m33.m_Zx ), m_Zy( m33.m_Zy ), m_Zz( m33.m_Zz ), m_Zw( 0.0 ),
...
Matrix44d::Matrix44d( Matrix43d const & m43 )
	: m_Xx( m43.m_Xx ), m_Xy( m43.m_Xy ), m_Xz( m43.m_Xz ), m_Xw( 0.0 ),
	  m_Yx( m43.m_Yx ), m_Yy( m43.m_Yy ), m_Yz( m43.m_Yz ), m_Yw( 0.0 ),
	  m_Zx( m43.m_Zx ), m_Zy( m43.m_Zy ), m_Zz( m43.m_Zz ), m_Zw( 0.0 ),
	  m_Tx( m43.m_Tx ), m_Ty( m43.m_Ty ), m_Tz( m43.m_Tz ), m_Tw( 1.0 )
{
}
...
Matrix44d::Matrix44d( Matrix44 const & m44f )
	: m_Xx( m44f.m_Xx ), m_Xy( m44f.m_Xy ), m_Xz( m44f.m_Xz ), m_Xw( m44f.m_Xw ),
	  m_Yx( m44f.m_Yx ), m_Yy( m44f.m_Yy ), m_Yz( m44f.m_Yz ), m_Yw( m44f.m_Yw ),
	  m_Zx( m44f.m_Zx ), m_Zy( m44f.m_Zy ), m_Zz( m44f.m_Zz ), m_Zw( m44f.m_Zw ),
	  m_Tx( m44f.m_Tx ), m_Ty( m44f.m_Ty ), m_Tz( m44f.m_Tz ), m_Tw( m44f.m_Tw )
{
}
